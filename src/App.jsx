...
function WhatsAppIcon({ size = 20 }) {
  // Logotipo do WhatsApp em SVG inline, sem dependência externa.
  // Símbolo reconhecível: balão + telefone, em verde oficial.
  const innerSize = Math.max(12, Math.round(size * 0.78));
  return (
    <span
      aria-hidden="true"
      style={{
