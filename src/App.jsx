  ...
  return (
    ...
    >
      ...
      <path
        ...
        fillRule="evenodd"
        clipRule="evenodd"
        d="M16 5.1c-5.9 0-10.7 4.7-10.7 10.5 0 2 .6 3.9 1.6 5.5L5.3 27l6-1.6c1.5.8 3.1 1.2 4.8 1.2 5.9 0 10.7-4.7 10.7-10.5S21.9 5.1 16 5.1Zm0 19.6c-1.6 0-3.1-.4-4.4-1.2l-.3-.2-3.5.9.9-3.4-.2-.4c-.9-1.4-1.4-3.1-1.4-4.8C7.1 10.7 11.1 6.9 16 6.9s8.9 3.9 8.9 8.7-4 9.1-8.9 9.1Z"
      />
      <path
        fill="#FFFFFF"
        d="M23.5 18.3c-.4-.2-2.2-1.1-2.6-1.2-.3-.1-.6-.2-.9.2-.2.4-1 1.2-1.2 1.4-.2.2-.4.2-.8.1-.4-.2-1.7-.6-3.2-1.9-1.2-1.1-2-2.3-2.2-2.7-.2-.4 0-.6.2-.8.2-.2.4-.4.6-.6.2-.2.3-.4.4-.6.1-.2 0-.4 0-.6 0-.2-.9-2.3-1.2-3.1-.3-.7-.6-.6-.9-.6h-.8c-.3 0-.6.1-.9.4-.3.3-1.2 1.2-1.2 3s1.3 3.6 1.5 3.8c.2.2 2.5 3.8 6 5.2.8.3 1.4.5 1.9.6.8.3 1.5.2 2.1.1.6-.1 2.2-.9 2.5-1.7.3-.8.3-1.6.2-1.7-.1-.1-.3-.2-.6-.3z"
      />
    </svg>
  );
}
